...
swayimg.gallery.border_color     = 0xffbd93fa

-- window/background
swayimg.gallery.window_color     = 0xee1e1e2e
swayimg.gallery.unselected_color = 0xee1e1e2e

-- select = #cba6f7ff
swayimg.gallery.selected_color   = 0xffcba6f7
...
-- Font / Text
-- ======================
swayimg.text.font                = "Sarasa Term SC"
...
-- info toggle
v.on_key("m", function()
    if swayimg.text.visible == true then
        swayimg.text.visible = false
    else
